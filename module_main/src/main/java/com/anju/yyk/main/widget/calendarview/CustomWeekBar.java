package com.anju.yyk.main.widget.calendarview;
...
public class CustomWeekBar extends WeekBar {
    ...
    public CustomWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.home_custom_week_bar, this, true);
    ...
    private String getWeekString(int index, int weekStart) {
        String[] weeks = getContext().getResources().getStringArray(R.array.home_chinese_week_string_array);
