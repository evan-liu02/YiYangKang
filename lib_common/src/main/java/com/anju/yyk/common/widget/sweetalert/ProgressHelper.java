package com.anju.yyk.common.widget.sweetalert;
...
import com.anju.yyk.common.widget.ProgressWheel;
...
public class ProgressHelper {
    ...
    public ProgressHelper(Context ctx) {
        ...
        mBarColor = ContextCompat.getColor(ctx, R.color.common_success_stroke_color);
        mRimWidth = 0;
